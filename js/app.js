...
window.onload = function() {
    window.setTimeout(function() {
        document.getElementsByClassName('bubble_container')[0].scrollIntoView({ behavior: "instant", block: "end", inline: "end" });
        document.getElementsByClassName('loader')[0].style.setProperty('animation', 'loaderslide .7s linear');
        window.setTimeout(function() {
            document.getElementsByClassName('loader')[0].style.setProperty('z-index', '-10');
            for (let i = 0; i < 3; i++) {
                document.getElementsByClassName('point')[i].style.setProperty('animation', 'none');
            }
            document.getElementsByClassName('loader')[0].style.setProperty('opacity', '0');
            window.setTimeout(function() {
                document.getElementsByClassName('bubble_container')[0].scrollIntoView({ behavior: "smooth", block: "start", inline: "nearest" });
            }, 100)
        }, 700)
    }, 700)
}
